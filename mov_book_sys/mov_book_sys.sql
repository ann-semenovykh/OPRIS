...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 03 2015 г., 22:16
...
INSERT INTO `hall` (`id_hall`, `stat`, `name`) VALUES
(1, 'большой', '1'),
(2, 'малый', '2'),
(3, 'большой', 'Синий'),
(4, 'малый', 'Красный');
...
INSERT INTO `session` (`id_mov`, `id_hall`, `time`, `price`) VALUES
(1, 1, '2015-12-02 22:45:00', 100),
(1, 1, '2015-12-02 12:45:00', 100),
(4, 1, '2015-12-02 22:45:00', 100),
(4, 2, '2015-12-02 23:40:00', 100),
(2, 2, '2015-12-03 22:30:00', 250),
(1, 1, '2015-12-03 20:00:00', 150),
(4, 4, '2015-12-03 20:00:00', 150),
(4, 4, '2015-12-03 10:00:00', 120),
(1, 2, '2015-12-03 20:00:00', 300),
(2, 3, '2015-12-03 21:50:00', 150);
...
--
ALTER TABLE `seats`
  ADD CONSTRAINT `FK_seats_users` FOREIGN KEY (`id_user`) REFERENCES `users` (`id_user`) ON DELETE SET NULL ON UPDATE CASCADE;
