		...
		<h4 id = "personal_title">Панель администратора</h4>
				...
				<form name = "personInfo_form" action = "/admin/add_session" method = "post" enctype="multipart/form-data">
					...
					<div class = "personalInfo_field">
						...
						<input type = "text" class = "personInfo_text" size="33" style="width:301px" value = "" name = "setDate">
					</div>
					<div class = "personalInfo_field">
						<h4 class = "personInfo_label">Цена</h4>
						<input type = "text" class = "personInfo_text" size="33" style="width:301px" value = "" name = "price">
					</div>
					<?php
						if (isset($errors)){
