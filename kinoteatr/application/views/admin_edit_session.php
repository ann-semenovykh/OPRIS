<div class = "content">
	...
	<form name = "personInfo_form" action = "<?php echo "/admin/edit_session/".$session->id_session;?>" method = "post" enctype="multipart/form-data">
		...
		<div class = "personalInfo_field">
			...
			<input type = "text" class = "panelInfo_text" size="33" style="width:301px" value = "<?php echo $session->time;?>" name = "setDate">
		</div>
		<div class = "personalInfo_field">
			<h4 class = "panelInfo_label">Цена</h4>
			<input type = "text" class = "panelInfo_text" size="33" style="width:301px" value = "<?php echo $session->price;?>" name = "price">
		</div>
		<?php
			if (isset($errors)){
